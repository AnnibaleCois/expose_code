...
* National Income Dynamics Study Wave 1 (DNIDS 2008)                                                                                                 *
...
* SOURCE FILES
global DATASET_1 "$BASEDIR/NIDS/Datafiles/Adult_W1_Anon_V7.0.0.dta"            // ADULT QUESTIONNAIRE
global DATASET_2 "$BASEDIR/NIDS/Datafiles/indderived_W1_Anon_V7.0.0.dta"       // INDIVIDUAL DERIVED 
global DATASET_3 "$BASEDIR/NIDS/Datafiles/HHQuestionnaire_W1_Anon_V7.0.0.dta"  // HOUSEHOLD QUESTIONNAIRE 
global DATASET_4 "$BASEDIR/NIDS/Datafiles/hhderived_W1_Anon_V7.0.0.dta"        // HOUSEHOLD DERIVED 
global DATASET_5 "$BASEDIR/NIDS/Datafiles/HouseholdRoster_W1_Anon_V7.0.0.dta"  // HOUSEHOLD ROSTER 
...
keep  w1_hhid pid w1_a_intrv_d w1_a_intrv_m w1_a_intrv_y w1_a_phase w1_a_marstt w1_a_bhprg w1_a_bhbrth w1_a_bhdob_y* w1_a_bhdth_n w1_a_bhali_n  ///
w1_a_bhlive_n w1_a_hllfexer w1_a_hllfalc w1_a_hllfalcqnt w1_a_hllfsmk w1_a_hllfsmkreg w1_a_hllfsmklst w1_a_hllfsmkfrs w1_a_hllfsmkqnt           /// 
w1_a_height_1 w1_a_height_2 w1_a_height_3 w1_a_weight_1 w1_a_weight_2 w1_a_weight_3 w1_a_bpsys_1 w1_a_bpsys_2 w1_a_bpdia_1 w1_a_bpdia_2         ///    
w1_a_bppls_1 w1_a_bppls_2 w1_a_waist_1 w1_a_waist_2 w1_a_waist_3 w1_a_hldes w1_a_hldia w1_a_hldia_stl w1_a_hlbp w1_a_hlbp_stl w1_a_hltb         ///
w1_a_hltb_stl w1_a_hlstrk w1_a_hlstrk_stl w1_a_hlast w1_a_hlast_stl w1_a_hlhrt w1_a_hlcan  w1_a_hlbp_med w1_a_hldia_med w1_a_hltb_med           ///
w1_a_hlstrk_med w1_a_hlast_med w1_a_hlmedaid w1_a_hlcon w1_a_hlcontyp  
...
use "$DATASET_2", clear  
keep w1_hhid pid w1_best_age_yrs w1_best_dob_m w1_best_dob_y w1_best_race w1_best_gen w1_best_edu w1_empl_stat   
...
keep  w1_hhid w1_h_dwlrms w1_h_dwlmatrwll w1_h_dwlmatroof w1_h_dwltyp w1_h_watsrc w1_h_watsrc_o w1_h_watdis w1_h_toi w1_h_toi_o w1_h_toishr     ///
w1_h_enrgck w1_h_enrgelec w1_h_ownrad w1_h_ownhif w1_h_owntel w1_h_ownsat w1_h_ownvid w1_h_owncom w1_h_owncam  w1_h_owncel w1_h_ownelestv       ///
w1_h_owngasstv w1_h_ownparstv w1_h_ownmic w1_h_ownfrg w1_h_ownwsh w1_h_ownsew w1_h_ownlng w1_h_ownvehpri w1_h_ownvehcom w1_h_ownmot             ///
w1_h_ownbic w1_h_ownboat w1_h_ownboatmot w1_h_owncrt w1_h_ownplg w1_h_owntra w1_h_ownwhl w1_h_ownmll w1_h_tellnd w1_h_telcel w1_h_ownd          /// 
w1_h_enrght w1_h_enrght_o w1_h_enrglght w1_h_enrglght_o w1_h_grn w1_h_hngradlt w1_h_hngrchld w1_h_food w1_h_refrem  w1_h_mrt24mnth              ///
w1_h_mrtdod_m* w1_h_mrtdod_y* w1_h_ag w1_h_agcom w1_h_agls w1_h_aglscat w1_h_aglsshp w1_h_aglshrs w1_h_aglsdnk w1_h_aglscatown w1_h_aglsshpown  ///
w1_h_aglsgtown w1_h_aglspigown w1_h_aglshrsown w1_h_aglsdnkown 
...
keep w1_hhid w1_cluster w1_wgt w1_dwgt w1_dtwgt w1_prov2011 w1_prov2001 w1_dc2011 w1_dc2001 w1_mdbdc2011 w1_geo2011 w1_geo2001 w1_hhsizer w1_hhincome
...
merge 1:1 w1_hhid using "$TEMP/TEMP_4.dta"
keep if _merge==3
drop _merge
...
* RECODING ASSETS FOR WEALTH INDEX CALCULATION

use "$TEMP/TEMP_3A.dta", clear

* Cooking fuel 
rename w1_h_enrgck cookingfuelw
...
* Roof material 
rename w1_h_dwlmatroof roofmaterial
...
rename w1_h_watsrc watersrc
replace watersrc=. if watersrc<0
replace watersrc=7 if watersrc==12 & (w1_h_watsrc_o=="RAIN WATER ON DRUMS" | w1_h_watsrc_o=="Rain water in drums" |   ///
                      w1_h_watsrc_o=="water on drums when it rains")
...
rename water13 water_neighbour
rename w1_h_toi toiletw
replace toiletw=. if toiletw<0
label variable toiletw "Toilet type"
rename w1_h_toishr toilet_shared
...
replace toilet_combined=15 if toiletw==7 /*No toilet*/
...
replace ass_donkey_horse_nc=1 if w1_h_aglsdnkown>0 & w1_h_aglsdnkown !=.
replace ass_donkey_horse_nc=1 if w1_h_aglshrsown>0 & w1_h_aglshrsown !=.
replace ass_donkey_horse_nc=0 if w1_h_aglsdnkown==0 & w1_h_aglshrsown==0
replace ass_donkey_horse_nc=0 if w1_h_aglsdnk==2 & w1_h_aglshrs==2
replace ass_donkey_horse_nc=0 if w1_h_ag==2 | w1_h_agcom==1 | w1_h_agls==2
...
keep ass_* cookw_* heat_* ntotrooms dwell_* ownhome wall_* roof_* water_* toilet_combined* refuseremoved w1_wgt w1_hhid
...
rename * w_NIDS2008_* 
rename w_NIDS2008_w1_wgt w1_wgt
rename w_NIDS2008_w1_hhid w1_hhid
...
use "$TEMP/TEMP_3B.dta", clear
merge 1:1 w1_hhid using "$TEMP/TEMP_3B_PCA.dta"
keep if _merge==3
drop _merge
...
merge 1:1 w1_hhid pid using "$TEMP/TEMP_2.dta"
keep if _merge==3
drop _merge
merge 1:1 w1_hhid pid using "$TEMP/TEMP_5.dta"
keep if _merge==3
drop _merge
...
merge m:1 w1_hhid using "$TEMP/TEMP_3C.dta"
keep if _merge==3
drop _merge
...
* Recoding marstatus status into three categories
generate marstatus=. 
replace marstatus=1 if w1_a_marstt==1 
replace marstatus=1 if w1_a_marstt==2
replace marstatus=2 if w1_a_marstt==3
replace marstatus=2 if w1_a_marstt==4 
replace marstatus=3 if w1_a_marstt==5
replace marstatus=. if w1_a_marstt<0
label values marstatus vmarstatus
label var marstatus "Marital status"

* Recoding Education*
recode w1_best_edu (25=0) (0/6=1) (7=2) (8/11=3) (13/14=3) (16/17=3) (12=4) (15=4) (18/19=5) (20/23=5) (24=9999) (-9/-3=.), gen(edu1)	
...
generate emp=.
replace emp=1 if w1_empl_stat==3
replace emp=0 if w1_empl_stat==1
replace emp=0 if w1_empl_stat==2
replace emp=0 if w1_empl_stat==0
replace emp=. if w1_empl_stat<0
label values emp vemp
label var emp "Employment status"

*Government grants/public assistance
recode w1_h_grn (-9/-3=.) (2=0), gen(recgrant)
...
generate alcfreq=.
replace alcfreq=0 if w1_a_hllfalc==1 | w1_a_hllfalc==2
replace alcfreq=0.25 if w1_a_hllfalc==3
replace alcfreq=0.5 if w1_a_hllfalc==4
replace alcfreq=1.5 if w1_a_hllfalc==5
replace alcfreq=3.5 if w1_a_hllfalc==6
replace alcfreq=5.5 if w1_a_hllfalc==7
replace alcfreq=7 if w1_a_hllfalc==8
label var alcfreq "Number drinking days per week"
generate alcqnt=.
replace alcqnt=18 if w1_a_hllfalcqnt==1
replace alcqnt=10.5 if w1_a_hllfalcqnt==2
replace alcqnt=7.5 if w1_a_hllfalcqnt==3
replace alcqnt=5.5 if w1_a_hllfalcqnt==4
replace alcqnt=3.5 if w1_a_hllfalcqnt==5
replace alcqnt=1.5 if w1_a_hllfalcqnt==6
label var alcqnt "Number of drinks per drinking occasion"
generate alcwk=alcfreq*alcqnt*12 
...
* Smoking
generate smokstatus=.
replace smokstatus=2 if w1_a_hllfsmk==1 /*Current smoker*/
replace smokstatus=1 if w1_a_hllfsmk==2 & w1_a_hllfsmkreg==1 /*Former smoker*/
replace smokstatus=0 if w1_a_hllfsmk==2 & w1_a_hllfsmkreg==2 /*Never smoker*/
...
* Physical activity
recode w1_a_hllfexer (1=0) (2=1) (3=2) (4=3) (5=4) (-9/-3=.), generate(exercisefreq)
...
replace housedeaths=0 if w1_h_mrt24mnth==2 
	*Death in the household more than 12 months ago 
replace housedeaths=0 if w1_h_mrt24mnth==1 & [((2008-w1_h_mrtdod_y1)>1 & (2008-w1_h_mrtdod_y1)!=.) | ((2008-w1_h_mrtdod_y1)==1 & ((w1_a_intrv_m-w1_h_mrtdod_m1)>0 & (w1_a_intrv_m-w1_h_mrtdod_m1)!=. ))] ///
& [((2008-w1_h_mrtdod_y2)>1 & (2008-w1_h_mrtdod_y2)!=.) | ((2008-w1_h_mrtdod_y2)==1 & ((w1_a_intrv_m-w1_h_mrtdod_m2)>0 & (w1_a_intrv_m-w1_h_mrtdod_m2)!=.)) | w1_h_mrtdod_y2==.] ///
& [((2008-w1_h_mrtdod_y3)>1 & (2008-w1_h_mrtdod_y3)!=.) | ((2008-w1_h_mrtdod_y3)==1 & ((w1_a_intrv_m-w1_h_mrtdod_m3)>0 & (w1_a_intrv_m-w1_h_mrtdod_m3)!=.)) | w1_h_mrtdod_y3==.] ///
& [((2008-w1_h_mrtdod_y4)>1 & (2008-w1_h_mrtdod_y4)!=.) | ((2008-w1_h_mrtdod_y4)==1 & ((w1_a_intrv_m-w1_h_mrtdod_m4)>0 & (w1_a_intrv_m-w1_h_mrtdod_m4)!=.)) | w1_h_mrtdod_y4==.] ///
& [((2008-w1_h_mrtdod_y5)>1 & (2008-w1_h_mrtdod_y5)!=.) | ((2008-w1_h_mrtdod_y5)==1 & ((w1_a_intrv_m-w1_h_mrtdod_m5)>0 & (w1_a_intrv_m-w1_h_mrtdod_m5)!=.)) | w1_h_mrtdod_y5==.] 
	*Death in household less than 12 months ago*/
replace housedeaths=1 if w1_h_mrt24mnth==1 & [(2008-w1_h_mrtdod_y1)==0 | (2008-w1_h_mrtdod_y2)==0 | (2008-w1_h_mrtdod_y3)==0 | (2008-w1_h_mrtdod_y4)==0 | (2008-w1_h_mrtdod_y5)==0] 
replace housedeaths=1 if w1_h_mrt24mnth==1 & [((2008-w1_h_mrtdod_y1)==1 & (w1_a_intrv_m-w1_h_mrtdod_m1)<=0) | ((2008-w1_h_mrtdod_y2)==1 & (w1_a_intrv_m-w1_h_mrtdod_m2)<=0) | ((2008-w1_h_mrtdod_y3)==1 & (w1_a_intrv_m-w1_h_mrtdod_m3)<=0) | ((2008-w1_h_mrtdod_y4)==1 & (w1_a_intrv_m-w1_h_mrtdod_m4)<=0) | ((2008-w1_h_mrtdod_y5)==1 & (w1_a_intrv_m-w1_h_mrtdod_m5)<=0)] 
	*Death in household a year ago, including those with missing month of death - (No observations)
replace housedeaths=1 if w1_h_mrt24mnth==1 & [((2008-w1_h_mrtdod_y1)==1 & w1_h_mrtdod_m1==.) | ((2008-w1_h_mrtdod_y2)==1 & w1_h_mrtdod_m2==.) | ((2008-w1_h_mrtdod_y3)==1 & w1_h_mrtdod_m3==.) | ((2008-w1_h_mrtdod_y4)==1 & w1_h_mrtdod_m4==.) | ((2008-w1_h_mrtdod_y5)==1 & w1_h_mrtdod_m5==.)] 
	*Death in household a year ago, including those with missing month of interview - (No observations)*
replace housedeaths=1 if w1_h_mrt24mnth==1 & [((2008-w1_h_mrtdod_y1)==1 & (w1_a_intrv_m==.)) | ((2008-w1_h_mrtdod_y2)==1 & (w1_a_intrv_m==.)) | ((2008-w1_h_mrtdod_y3)==1 & (w1_a_intrv_m==.)) | ((2008-w1_h_mrtdod_y4)==1 & (w1_a_intrv_m==.)) | ((2008-w1_h_mrtdod_y5)==1 & (w1_a_intrv_m==.))] 
...
replace housedeaths=. if w1_h_mrt24mnth==1 & [(w1_h_mrtdod_y1==3333 | w1_h_mrtdod_y1==9999 | w1_h_mrtdod_y1==8888) & (w1_h_mrtdod_y2==3333 | w1_h_mrtdod_y2==9999 | w1_h_mrtdod_y2==8888) & (w1_h_mrtdod_y3==3333 | w1_h_mrtdod_y3==9999 | w1_h_mrtdod_y3==8888) & (w1_h_mrtdod_y4==3333 | w1_h_mrtdod_y4==9999 | w1_h_mrtdod_y4==8888) & (w1_h_mrtdod_y5==3333 | w1_h_mrtdod_y5==9999 | w1_h_mrtdod_y5==8888)] 

* Food security 
gen foodinsec=.
label var foodinsec "Food insecurity"
replace foodinsec=. if w1_h_hngradlt==-3 & w1_h_hngrchld==-3 /*Missing*/
replace foodinsec=0 if w1_h_hngradlt==-5 & w1_h_hngrchld==-5 /*Not applicable*/
replace foodinsec=0 if w1_h_hngradlt==1 & w1_h_hngrchld==1 /*Never*/
replace foodinsec=1 if w1_h_hngradlt==2 | w1_h_hngrchld==2 /*Seldom*/
replace foodinsec=1 if w1_h_hngradlt==3 | w1_h_hngrchld==3 /*Sometimes*/
replace foodinsec=1 if w1_h_hngradlt==4 | w1_h_hngrchld==4 /*Often*/
replace foodinsec=1 if w1_h_hngradlt==5 | w1_h_hngrchld==5 /*Always*/
label values foodinsec vyesno

recode w1_h_hngradlt (-3=.)(-5=0) (1=0) (2/5=1), gen(foodinsec_adult)
label var foodinsec_adult "Food insecurity: adult"
label values foodinsec_adult vyesno

recode w1_h_hngrchld (-3=.)(-5=0) (1=0) (2/5=1), gen(foodinsec_child)
label var foodinsec_child "Food insecurity: child"
label values foodinsec_child vyesno

gen foodmoney=w1_h_food
label var foodmoney "Household ran out of money to buy food in last 30 days"
replace foodmoney=. if w1_h_food<0
replace foodmoney=0 if w1_h_food==2 | w1_h_food==3
replace foodmoney=1 if w1_h_food==1
label values foodmoney vyesno
tab foodmoney

* Self-rated health
recode w1_a_hldes (5=1) (4=2) (3=3) (1/2=4) (-9/-3=.), generate(self_health)
label var self_health "Perceived health status"
label values self_health vself_health

* Medical care in the last year
recode w1_a_hlcon (1/3=1) (4/8=0) (-9/-3=.), gen(hcare12mo)
label values hcare12mo vyesno
label variable hcare12mo "Health consultation last year"

* Medical care in the last month
recode w1_a_hlcon (1=1) (2/8=0) (-9/-3=.), gen(hcare1mo)
label values hcare1mo vyesno
label variable hcare1mo "Health consultation last month"
generate hcare1mo_type=.
replace hcare1mo_type=1 if ((w1_a_hlcontyp==1 | w1_a_hlcontyp==3) & hcare1mo==1) /*Public*/
replace hcare1mo_type=2 if ((w1_a_hlcontyp==2 | w1_a_hlcontyp==4 | w1_a_hlcontyp==5) & hcare1mo==1) /*Private*/
replace hcare1mo_type=3 if (w1_a_hlcontyp==6  & hcare1mo==1) /*Chemist/nurse*/
replace hcare1mo_type=4 if (w1_a_hlcontyp==7  & hcare1mo==1) /*Traditional*/
label variable hcare1mo_type "Health consultation type, 1 month"
label values hcare1mo_type vhvisit
...
gen diabmed=.
replace diabmed=1 if w1_a_hldia_med==1 /*Yes*/
replace diabmed=0 if w1_a_hldia_med==2 /*No*/
...
gen tbmed=.
replace tbmed=1 if w1_a_hltb_med==1 /*Yes*/
replace tbmed=0 if w1_a_hltb_med==2 /*No*/
replace tbmed=0 if diag_tb==0 /*No*/
label values tbmed vyesno
label variable tbmed "Current use of TB medication  - self"
gen strokemed=.
replace strokemed=1 if w1_a_hlstrk_med==1 /*Yes*/
replace strokemed=0 if w1_a_hlstrk_med==2 /*No*/
...
gen asthmed=.
replace asthmed=1 if w1_a_hlast_med==1 /*Yes*/
replace asthmed=0 if w1_a_hlast_med==2 /*No*/
...
drop w1_*
drop toilet_combined* water_* heat_* dwell_* wall_* roof_* cookw_*
drop toiletw dwellingw watersrc cookingfuelw heatingfuelw parity2
drop hcare1mo_type alcwk toilet_shared
drop wallmaterial roofmaterial foodmoney
...
local n = 1
	...
	label var `asset' "NIDS2008 - Asset index indicator - `n'"
	local n = `n' + 1
}
...
* Label the dataset
label data "NIDS 2008 - Core Variables - $S_DATE"
...
collapse (max) primaryed_hh=primaryed (count) edunum=primaryed, by(w1_hhid)
label var primaryed_hh "A household member completed primary school"
label values primaryed_hh vyesno

* Save temporary
save "$TEMP/TEMP_7B.dta", replace

*Merging household education indicator variables to dataset*

use "$TEMP/TEMP_7A.dta", clear
merge 1:1 w1_hhid using "$TEMP/TEMP_7B.dta"
keep if _merge==3
drop _merge

replace primaryed_hh=. if primaryed_hh==0 & edunum < w1_hhsizer
...
save "$TEMP/TEMP_7C.dta", replace

******************************************************************************************************************************************************
* SAVE & ERASE TEMPORARY FILES                                                                                                                       * 
******************************************************************************************************************************************************

use "$TEMP/TEMP_6.dta", clear
merge m:1 hhid using "$TEMP/TEMP_7C.dta"
keep if _merge == 3
drop _merge
...
erase "$TEMP/TEMP_6.dta"
erase "$TEMP/TEMP_7A.dta"
erase "$TEMP/TEMP_7B.dta"
erase "$TEMP/TEMP_7C.dta"
