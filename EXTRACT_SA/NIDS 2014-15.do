...
* National Income Dynamics Study Wave 4 (NIDS 2014-15)                                                                                               *
...
* SOURCE FILES
global DATASET_1 "$BASEDIR/NIDS/Datafiles/Adult_W4_Anon_V2.0.0.dta"            // ADULT QUESTIONNAIRE
global DATASET_2 "$BASEDIR/NIDS/Datafiles/indderived_W4_Anon_V2.0.0.dta"       // INDIVIDUAL DERIVED 
global DATASET_3 "$BASEDIR/NIDS/Datafiles/HHQuestionnaire_W4_Anon_V2.0.0.dta"  // HOUSEHOLD QUESTIONNAIRE 
global DATASET_4 "$BASEDIR/NIDS/Datafiles/hhderived_W4_Anon_V2.0.0.dta"        // HOUSEHOLD DERIVED 
global DATASET_4A "$BASEDIR/NIDS/Datafiles/Link_File_W4_Anon_V2.0.0.dta"       // LINK FILE
...
keep  w4_hhid pid w4_a_intrv_d w4_a_intrv_m w4_a_intrv_y w4_a_bhprg w4_a_bhbrth w4_a_bhcnt1con w4_a_hllfexer w4_a_hllfalc w4_a_hllfalcqnt        ///
w4_a_hllfsmk w4_a_hllfsmkreg w4_a_hllfsmklst w4_a_hllfsmkfrs w4_a_hllfsmkqnt w4_a_height_1 w4_a_height_2 w4_a_height_3 w4_a_weight_1             ///
w4_a_weight_2 w4_a_weight_3 w4_a_bpsys_1 w4_a_bpsys_2 w4_a_bpdia_1 w4_a_bpdia_2 w4_a_bppls_1 w4_a_bppls_2 w4_a_waist_1 w4_a_waist_2 w4_a_waist_3 ///
w4_a_hldes w4_a_hldia w4_a_hldia_bf w4_a_hldia_stl w4_a_hlbp w4_a_hlbp_bf w4_a_hlbp_stl w4_a_hltb w4_a_hltb_bf w4_a_hltb_stl w4_a_hlstrk         ///
w4_a_hlstrk_bf w4_a_hlstrk_stl w4_a_hlast w4_a_hlast_bf w4_a_hlast_stl w4_a_hlhrt w4_a_hlhrt_bf w4_a_hlcan w4_a_hlcan_bf w4_a_hlbp_med           ///
w4_a_hldia_med w4_a_hltb_med w4_a_hlstrk_med w4_a_hlast_med w4_a_hlcon w4_a_hlcontyp w4_a_hlmedaid 
...
use "$DATASET_2", clear  
keep w4_hhid pid w4_best_age_yrs w4_best_dob_m w4_best_dob_y w4_best_race w4_best_gen w4_best_marstt w4_best_edu w4_empl_stat 
...
keep  w4_hhid w4_h_dwlrms w4_h_dwlmatrwll w4_h_dwlmatflr w4_h_dwlmatroof w4_h_dwltyp w4_h_dwltyp_o w4_h_watsrc w4_h_watsrc_o w4_h_watdis           /// 
w4_h_toi w4_h_toi_o w4_h_toishr w4_h_enrgck w4_h_enrgck_o w4_h_enrgelec w4_h_ownrad w4_h_ownhif w4_h_owntel w4_h_ownsat w4_h_ownvid                ///
w4_h_owncom w4_h_owncam w4_h_owncel w4_h_ownelestv w4_h_owngasstv w4_h_ownparstv w4_h_ownmic w4_h_ownfrg w4_h_ownwsh w4_h_ownsew w4_h_ownlng       ///
w4_h_ownvehpri w4_h_ownmot w4_h_ownbic w4_h_ownboat w4_h_ownboatmot w4_h_owncrt w4_h_ownplg w4_h_owntra w4_h_ownwhl w4_h_ownmll w4_h_tellnd        ///
w4_h_telcel w4_h_ownd w4_h_ownpaid w4_h_enrght w4_h_enrght_o w4_h_enrglght w4_h_enrglght_o w4_h_grn w4_h_refrem w4_h_mrt24mnth w4_h_mrtdod_m*      ///
w4_h_mrtdod_y* w4_h_ag w4_h_agcom w4_h_agls w4_h_aglscat w4_h_aglsshp w4_h_aglshrs w4_h_aglsdnk w4_h_aglscatown w4_h_aglsshpown w4_h_aglshrsown    ///
w4_h_aglsdnkown 
...
keep w4_hhid w4_wgt w4_dwgt w4_prov2011 w4_prov2001 w4_dc2011 w4_dc2001 w4_mdbdc2011 w4_geo2011 w4_geo2001 w4_hhsizer w4_hhincome
...
merge 1:1 w4_hhid using "$TEMP/TEMP_4.dta"
keep if _merge==3
drop _merge
...
* Cooking fuel 
rename w4_h_enrgck cookingfuelw
...
* Heating fuel
rename w4_h_enrght heatingfuelw
...
* Roof material
rename w4_h_dwlmatroof roofmaterial
...
* Floor material 
rename w4_h_dwlmatflr floormaterial
...
replace ass_donkey_horse_nc=1 if w4_h_aglsdnkown>0 & w4_h_aglsdnkown !=.
replace ass_donkey_horse_nc=1 if w4_h_aglshrsown>0 & w4_h_aglshrsown !=.
replace ass_donkey_horse_nc=0 if w4_h_aglsdnkown==0 & w4_h_aglshrsown==0
replace ass_donkey_horse_nc=0 if w4_h_aglsdnk==2 & w4_h_aglshrs==2
replace ass_donkey_horse_nc=0 if w4_h_ag==2 | w4_h_agcom==1 | w4_h_agls==2
...
keep ass_* cookw_* heat_* ntotrooms dwell_* ownhome wall_* roof_* water_* toilet_combined* refuseremoved w4_wgt w4_hhid
...
rename * w_NIDS2014_* 
rename w_NIDS2014_w4_wgt w4_wgt
rename w_NIDS2014_w4_hhid w4_hhid
...
use "$TEMP/TEMP_3B.dta", clear
merge 1:1 w4_hhid using "$TEMP/TEMP_3B_PCA.dta"
keep if _merge==3
drop _merge
...
merge 1:1 w4_hhid pid using "$TEMP/TEMP_2.dta"
keep if _merge==3
drop _merge
merge 1:1 w4_hhid pid using "$TEMP/TEMP_4A.dta"
keep if _merge==3
drop _merge
...
merge m:1 w4_hhid using "$TEMP/TEMP_3C.dta"
keep if _merge==3
drop _merge
...
* Marital status
generate marstatus=. 
replace marstatus=1 if w4_best_marstt==1 /*married/living with partner*/
replace marstatus=1 if w4_best_marstt==2 /*married/living with partner*/
replace marstatus=2 if w4_best_marstt==3 /*widowed/divorced*/
replace marstatus=2 if w4_best_marstt==4 /*widowed/divorced*/
replace marstatus=3 if w4_best_marstt==5 /*never married/single*/
replace marstatus=. if w4_best_marstt<0  /*missing/unknown*/
label values marstatus vmarstatus
label var marstatus "Marital status"

* Education, primary secondary
recode w4_best_edu (25=0) (0/6=1) (7=2) (8/11=3) (13/14=3) (16/17=3) (12=4) (15=4) (18/19=5) (20/23=5) (24=9999) (-9/-3=.), gen(edu1)	 
...
* Employment status
generate emp=.
replace emp=1 if w4_empl_stat==3 /*employed*/ 
replace emp=0 if w4_empl_stat==1 /*unemployed discouraged*/
replace emp=0 if w4_empl_stat==2 /*unemployed strict*/ 
replace emp=0 if w4_empl_stat==0 /*not economically active*/  
replace emp=. if w4_empl_stat<0
label values emp vemp
label var emp "Employment status"

* Government grants/public assistance
recode w4_h_grn (-9/-3=.) (2=0), gen(recgrant)
...
* Reproductive
gen currpreg=.
replace currpreg=0 if w4_a_bhprg==2 
replace currpreg=0 if w4_a_bhprg==-9 
replace currpreg=1 if w4_a_bhprg==1 
label values currpreg vcurrpreg
label var currpreg "Currently pregnant"
gen everpreg=. 
replace everpreg=0 if w4_a_bhbrth==2 
replace everpreg=1 if w4_a_bhbrth==1 
label values everpreg vyesno
label var everpreg "Ever pregnant"
gen parity=w4_a_bhcnt1con
replace parity=. if w4_a_bhcnt1con<0
label var parity "Parity"

* Alcohol use
generate alcstatus=.
replace alcstatus=0 if w4_a_hllfalc==1
replace alcstatus=1 if w4_a_hllfalc==2
replace alcstatus=2 if w4_a_hllfalc>2
replace alcstatus=. if w4_a_hllfalc<0
replace alcstatus=. if w4_a_hllfalc==.
...
generate alcfreq=.
replace alcfreq=0 if w4_a_hllfalc==1 | w4_a_hllfalc==2
replace alcfreq=0.25 if w4_a_hllfalc==3
replace alcfreq=0.5 if w4_a_hllfalc==4
replace alcfreq=1.5 if w4_a_hllfalc==5
replace alcfreq=3.5 if w4_a_hllfalc==6
replace alcfreq=5.5 if w4_a_hllfalc==7
replace alcfreq=7 if w4_a_hllfalc==8
label var alcfreq "Number drinking days per week"
generate alcqnt=.
replace alcqnt=18 if w4_a_hllfalcqnt==1
replace alcqnt=10.5 if w4_a_hllfalcqnt==2
replace alcqnt=7.5 if w4_a_hllfalcqnt==3
replace alcqnt=5.5 if w4_a_hllfalcqnt==4
replace alcqnt=3.5 if w4_a_hllfalcqnt==5
replace alcqnt=1.5 if w4_a_hllfalcqnt==6
...
* Smoking 
generate smokstatus=.
replace smokstatus=2 if w4_a_hllfsmk==1
replace smokstatus=1 if w4_a_hllfsmk==2 & w4_a_hllfsmkreg==1 
replace smokstatus=0 if w4_a_hllfsmk==2 & w4_a_hllfsmkreg==2 
...
* Physical activity
recode w4_a_hllfexer (1=0) (2=1) (3=2) (4=3) (5=4) (-9/-2=.), generate(exercisefreq)
...
replace housedeaths=0 if w4_h_mrt24mnth==2 
	*Death in the household more than 12 months ago
replace housedeaths=0 if w4_h_mrt24mnth==1 & [((w4_a_intrv_y-w4_h_mrtdod_y1)>1 & (w4_a_intrv_y-w4_h_mrtdod_y1)!=.) | ((w4_a_intrv_y-w4_h_mrtdod_y1)==1 & ((w4_a_intrv_m-w4_h_mrtdod_m1)>0) & (w4_a_intrv_m-w4_h_mrtdod_m1)!=.)] ///
& [((w4_a_intrv_y-w4_h_mrtdod_y2)>1 & (w4_a_intrv_y-w4_h_mrtdod_y2)!=.) | ((w4_a_intrv_y-w4_h_mrtdod_y2)==1 & ((w4_a_intrv_m-w4_h_mrtdod_m2)>0 & (w4_a_intrv_m-w4_h_mrtdod_m2)!=.)) | w4_h_mrtdod_y2==.] ///
& [((w4_a_intrv_y-w4_h_mrtdod_y3)>1 & (w4_a_intrv_y-w4_h_mrtdod_y3)!=.) | ((w4_a_intrv_y-w4_h_mrtdod_y3)==1 & ((w4_a_intrv_m-w4_h_mrtdod_m3)>0 & (w4_a_intrv_m-w4_h_mrtdod_m3)!=.)) | w4_h_mrtdod_y3==.] 
	*Death in household less than 12 months ago
replace housedeaths=1 if w4_h_mrt24mnth==1 & [(w4_a_intrv_y-w4_h_mrtdod_y1)==0 | (w4_a_intrv_y-w4_h_mrtdod_y2)==0 | (w4_a_intrv_y-w4_h_mrtdod_y3)==0] 
	*Death in household less than 12 months ago
replace housedeaths=1 if w4_h_mrt24mnth==1 & [((w4_a_intrv_y-w4_h_mrtdod_y1)==1 & (w4_a_intrv_m-w4_h_mrtdod_m1)<=0) | ((w4_a_intrv_y-w4_h_mrtdod_y2)==1 & (w4_a_intrv_m-w4_h_mrtdod_m2)<=0) | ((w4_a_intrv_y-w4_h_mrtdod_y3)==1 & (w4_a_intrv_m-w4_h_mrtdod_m3)<=0)] 
	*Death in household a year ago, including those with missing month of death - (No observations)
replace housedeaths=1 if w4_h_mrt24mnth==1 & [((w4_a_intrv_y-w4_h_mrtdod_y1)==1 & w4_h_mrtdod_m1==.) | ((w4_a_intrv_y-w4_h_mrtdod_y2)==1 & w4_h_mrtdod_m2==.) | ((w4_a_intrv_y-w4_h_mrtdod_y3)==1 & w4_h_mrtdod_m3==.)] 
	*Death in household a year ago, including those with missing month of interview - (No observations)
replace housedeaths=1 if w4_h_mrt24mnth==1 & [((w4_a_intrv_y-w4_h_mrtdod_y1)==1 & (w4_a_intrv_m==.)) | ((w4_a_intrv_y-w4_h_mrtdod_y2)==1 & (w4_a_intrv_m==.)) | ((w4_a_intrv_y-w4_h_mrtdod_y3)==1 & (w4_a_intrv_m==.))] 
...
gen asthmed=.
replace asthmed=1 if w4_a_hlast_med==1 /*Yes*/
replace asthmed=0 if w4_a_hlast_med==2 /*No*/
...
rename w4_best_gen sex
replace sex=. if sex<0
label var sex "Sex"
label val sex vsex
rename w4_best_age_yrs age
...
local n = 1
	...
	label var `asset' "NIDS2014-15 - Asset index indicator - `n'"
	local n = `n' + 1
}
...
collapse (max) primaryed_hh=primaryed (count) edunum=primaryed, by(w4_hhid)
...
merge 1:1 w4_hhid using "$TEMP/TEMP_6B.dta"
keep if _merge==3
drop _merge

replace primaryed_hh=. if primaryed_hh==0 & edunum < w4_hhsizer
...
* Label the dataset
label data "NIDS 2014-15 - Core Variables - $S_DATE"

save "$TEMP/NIDS2014-15.dta", replace
