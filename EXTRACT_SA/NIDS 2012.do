...
* National Income Dynamics Study Wave 3 (NIDS 2012)                                                                                                  *
...
* SOURCE FILES
global DATASET_1 "$BASEDIR/NIDS/Datafiles/Adult_W3_Anon_V3.0.0.dta"            // ADULT QUESTIONNAIRE
global DATASET_2 "$BASEDIR/NIDS/Datafiles/indderived_W3_Anon_V3.0.0.dta"       // INDIVIDUAL DERIVED 
global DATASET_3 "$BASEDIR/NIDS/Datafiles/HHQuestionnaire_W3_Anon_V3.0.0.dta"  // HOUSEHOLD QUESTIONNAIRE 
global DATASET_4 "$BASEDIR/NIDS/Datafiles/hhderived_W3_Anon_V3.0.0.dta"        // HOUSEHOLD DERIVED 
global DATASET_4A "$BASEDIR/NIDS/Datafiles/Link_File_W3_Anon_V3.0.0.dta"       // LINK FILE
...
keep  w3_hhid pid w3_a_intrv_d w3_a_intrv_m w3_a_intrv_y w3_a_marstt w3_a_bhprg w3_a_bhbrth w3_a_bhcnt1con w3_a_hllfexer w3_a_hllfalc        ///
w3_a_hllfalcqnt w3_a_hllfsmk w3_a_hllfsmkreg w3_a_hllfsmklst w3_a_hllfsmkfrs w3_a_hllfsmkqnt w3_a_height_1 w3_a_height_2 w3_a_height_3       ///
w3_a_weight_1 w3_a_weight_2 w3_a_weight_3 w3_a_bpsys_1 w3_a_bpsys_2 w3_a_bpdia_1 w3_a_bpdia_2 w3_a_bppls_1 w3_a_bppls_2 w3_a_waist_1         ///
w3_a_waist_2 w3_a_waist_3 w3_a_hldes w3_a_hldia w3_a_hldia_stl w3_a_hlbp w3_a_hlbp_stl w3_a_hltb w3_a_hltb_stl w3_a_hlstrk w3_a_hlstrk_stl   ///
w3_a_hlast w3_a_hlast_stl w3_a_hlhrt w3_a_hlcan w3_a_hlbp_med w3_a_hldia_med w3_a_hltb_med w3_a_hlstrk_med w3_a_hlast_med w3_a_hlmedaid      ///
w3_a_hlcon w3_a_hlcontyp 
...
keep w3_hhid pid w3_best_age_yrs w3_best_dob_m w3_best_dob_y w3_best_race w3_best_gen w3_best_edu w3_empl_stat /*demographic and SES*/
...
keep  w3_hhid w3_h_dwlrms w3_h_dwlmatrwll w3_h_dwlmatflr w3_h_dwlmatroof w3_h_dwltyp w3_h_dwltyp_o w3_h_watsrc w3_h_watsrc_o w3_h_watdis w3_h_toi  ///
w3_h_toi_o w3_h_toishr w3_h_enrgck w3_h_enrgelec w3_h_ownrad w3_h_ownhif w3_h_owntel w3_h_ownsat w3_h_ownvid w3_h_owncom w3_h_owncam w3_h_owncel   ///
w3_h_ownelestv w3_h_owngasstv w3_h_ownparstv w3_h_ownmic w3_h_ownfrg w3_h_ownwsh w3_h_ownsew w3_h_ownlng w3_h_ownvehpri w3_h_ownvehcom             ///
w3_h_ownmot w3_h_ownbic w3_h_ownboat w3_h_ownboatmot w3_h_owncrt w3_h_ownplg w3_h_owntra w3_h_ownwhl w3_h_ownmll w3_h_tellnd w3_h_telcel           ///
w3_h_enrght w3_h_enrglght w3_h_ownd w3_h_grn w3_h_refrem w3_h_mrt24mnth w3_h_mrtdod_m* w3_h_mrtdod_y* w3_h_ag w3_h_agcom w3_h_agls w3_h_aglscat    ///
w3_h_aglsshp w3_h_aglshrs w3_h_aglsdnk w3_h_aglscatown w3_h_aglsshpown w3_h_aglshrsown w3_h_aglsdnkown 
...
keep w3_hhid w3_wgt w3_dwgt w3_prov2011 w3_prov2001 w3_dc2011 w3_dc2001 w3_mdbdc2011 w3_geo2011 w3_geo2001 w3_hhsizer w3_hhincome
...
merge 1:1 w3_hhid using "$TEMP/TEMP_4.dta"
keep if _merge==3
drop _merge
...
* Cooking fuel 
rename w3_h_enrgck cookingfuelw
...
* Heating fuel
rename w3_h_enrght heatingfuelw
...
* Roof material
rename w3_h_dwlmatroof roofmaterial
...
* Floor material
rename w3_h_dwlmatflr floormaterial
...
replace ass_donkey_horse_nc=1 if w3_h_aglsdnkown>0 & w3_h_aglsdnkown !=.
replace ass_donkey_horse_nc=1 if w3_h_aglshrsown>0 & w3_h_aglshrsown !=.
replace ass_donkey_horse_nc=0 if w3_h_aglsdnkown==0 & w3_h_aglshrsown==0
replace ass_donkey_horse_nc=0 if w3_h_aglsdnk==2 & w3_h_aglshrs==2
replace ass_donkey_horse_nc=0 if w3_h_ag==2 | w3_h_agcom==1 | w3_h_agls==2
...
keep ass_* cookw_* heat_* ntotrooms dwell_* ownhome wall_* roof_* water_* toilet_combined* refuseremoved w3_wgt w3_hhid
...
rename * w_NIDS2012_* 
rename w_NIDS2012_w3_wgt w3_wgt
rename w_NIDS2012_w3_hhid w3_hhid
...
use "$TEMP/TEMP_3B.dta", clear
merge 1:1 w3_hhid using "$TEMP/TEMP_3B_PCA.dta"
keep if _merge==3
drop _merge
...
merge 1:1 w3_hhid pid using "$TEMP/TEMP_2.dta"
keep if _merge==3
drop _merge
merge 1:1 w3_hhid pid using "$TEMP/TEMP_4A.dta"
keep if _merge==3
drop _merge
...
merge m:1 w3_hhid using "$TEMP/TEMP_3C.dta"
keep if _merge==3
drop _merge
...
* Marital status into three categories
generate marstatus=. 
replace marstatus=1 if w3_a_marstt==1 /*married/living with partner*/
replace marstatus=1 if w3_a_marstt==2 /*married/living with partner*/
replace marstatus=2 if w3_a_marstt==3 /*widowed/divorced*/
replace marstatus=2 if w3_a_marstt==4 /*widowed/divorced*/
replace marstatus=3 if w3_a_marstt==5 /*never married/single*/
replace marstatus=. if w3_a_marstt<0  /*missing/unknown*/
label values marstatus vmarstatus
label var marstatus "Marital status"

* Employment status
generate emp=.
replace emp=1 if w3_empl_stat==3 /*employed*/ 
replace emp=0 if w3_empl_stat==1 /*unemployed discouraged*/
replace emp=0 if w3_empl_stat==2 /*unemployed strict*/ 
replace emp=0 if w3_empl_stat==0 /*not economically active*/  
replace emp=. if w3_empl_stat<0
label values emp vemp
label var emp "Employment status"

* Recoding education, primary secondary 
recode w3_best_edu (25=0) (0/6=1) (7=2) (8/11=3) (13/14=3) (16/17=3) (12=4) (15=4) (18/19=5) (20/23=5) (24=9999) (-9/-3=.), gen(edu1)	 
...
recode w3_h_grn (-9/-3=.) (2=0), gen(recgrant)
...
gen currpreg=.
replace currpreg=0 if w3_a_bhprg==2 
replace currpreg=0 if w3_a_bhprg==-9 
replace currpreg=1 if w3_a_bhprg==1
label values currpreg vcurrpreg
label var currpreg "Currently pregnant"
gen everpreg=. 
replace everpreg=0 if w3_a_bhbrth==2 
replace everpreg=1 if w3_a_bhbrth==1 
label values everpreg vyesno
label var everpreg "Ever pregnant"
gen parity=w3_a_bhcnt1con
replace parity=. if w3_a_bhcnt1con<0
label var parity "Parity"

* Alcohol use
generate alcstatus=.
replace alcstatus=0 if w3_a_hllfalc==1
replace alcstatus=1 if w3_a_hllfalc==2
replace alcstatus=2 if w3_a_hllfalc>2
replace alcstatus=. if w3_a_hllfalc<0
replace alcstatus=. if w3_a_hllfalc==.
...
generate alcfreq=.
replace alcfreq=0 if w3_a_hllfalc==1 | w3_a_hllfalc==2
replace alcfreq=0.25 if w3_a_hllfalc==3
replace alcfreq=0.5 if w3_a_hllfalc==4
replace alcfreq=1.5 if w3_a_hllfalc==5
replace alcfreq=3.5 if w3_a_hllfalc==6
replace alcfreq=5.5 if w3_a_hllfalc==7
replace alcfreq=7 if w3_a_hllfalc==8
label var alcfreq "Number drinking days per week"
generate alcqnt=.
replace alcqnt=18 if w3_a_hllfalcqnt==1
replace alcqnt=10.5 if w3_a_hllfalcqnt==2
replace alcqnt=7.5 if w3_a_hllfalcqnt==3
replace alcqnt=5.5 if w3_a_hllfalcqnt==4
replace alcqnt=3.5 if w3_a_hllfalcqnt==5
replace alcqnt=1.5 if w3_a_hllfalcqnt==6
...
* Smoking 
generate smokstatus=.
replace smokstatus=2 if w3_a_hllfsmk==1
replace smokstatus=1 if w3_a_hllfsmk==2 & w3_a_hllfsmkreg==1 
replace smokstatus=0 if w3_a_hllfsmk==2 & w3_a_hllfsmkreg==2 
...
* Physical activity
recode w3_a_hllfexer (1=0) (2=1) (3=2) (4=3) (5=4) (-9/-2=.), generate(exercisefreq)
...
replace housedeaths=0 if w3_h_mrt24mnth==2 
	*Death in the household more than 12 months ago
replace housedeaths=0 if w3_h_mrt24mnth==1 & [((2012-w3_h_mrtdod_y1)>1 & (2012-w3_h_mrtdod_y1)!=.) | ((2012-w3_h_mrtdod_y1)==1 & ((w3_a_intrv_m-w3_h_mrtdod_m1)>0 & (w3_a_intrv_m-w3_h_mrtdod_m1)!=.))] ///
& [((2012-w3_h_mrtdod_y2)>1 & (2012-w3_h_mrtdod_y2)!=.) | ((2012-w3_h_mrtdod_y2)==1 & ((w3_a_intrv_m-w3_h_mrtdod_m2)>0 & (w3_a_intrv_m-w3_h_mrtdod_m2)!=.)) | w3_h_mrtdod_y2==.] ///
& [((2012-w3_h_mrtdod_y3)>1 & (2012-w3_h_mrtdod_y3)!=.) | ((2012-w3_h_mrtdod_y3)==1 & ((w3_a_intrv_m-w3_h_mrtdod_m3)>0 & (w3_a_intrv_m-w3_h_mrtdod_m3)!=.)) | w3_h_mrtdod_y3==.] ///
& [((2012-w3_h_mrtdod_y4)>1 & (2012-w3_h_mrtdod_y4)!=.) | ((2012-w3_h_mrtdod_y4)==1 & ((w3_a_intrv_m-w3_h_mrtdod_m4)>0 & (w3_a_intrv_m-w3_h_mrtdod_m4)!=.)) | w3_h_mrtdod_y4==.] 
	*Death in household less than 12 months ago
replace housedeaths=1 if w3_h_mrt24mnth==1 & [(2012-w3_h_mrtdod_y1)==0 | (2012-w3_h_mrtdod_y2)==0 | (2012-w3_h_mrtdod_y3)==0 | (2012-w3_h_mrtdod_y4)==0] 
	*Death in household less than 12 months ago 
replace housedeaths=1 if w3_h_mrt24mnth==1 & [((2012-w3_h_mrtdod_y1)==1 & (w3_a_intrv_m-w3_h_mrtdod_m1)<=0) | ((2012-w3_h_mrtdod_y2)==1 & (w3_a_intrv_m-w3_h_mrtdod_m2)<=0) | ((2012-w3_h_mrtdod_y3)==1 & (w3_a_intrv_m-w3_h_mrtdod_m3)<=0) | ((2012-w3_h_mrtdod_y4)==1 & (w3_a_intrv_m-w3_h_mrtdod_m4)<=0)] 
	*Death in household a year ago, including those with missing month of interview -(No observations)
replace housedeaths=1 if w3_h_mrt24mnth==1 & [((2012-w3_h_mrtdod_y1)==1 & (w3_a_intrv_m==.)) | ((2012-w3_h_mrtdod_y2)==1 & (w3_a_intrv_m==.)) | ((2012-w3_h_mrtdod_y3)==1 & (w3_a_intrv_m==.)) | ((2012-w3_h_mrtdod_y4)==1 & (w3_a_intrv_m==.))] 
	*Death in household a year ago, including those with missing month of death - (No observations)
replace housedeaths=1 if w3_h_mrt24mnth==1 & [((2012-w3_h_mrtdod_y1)==1 & (w3_h_mrtdod_m1==.)) | ((2012-w3_h_mrtdod_y2)==1 & (w3_h_mrtdod_m2==.)) | ((2012-w3_h_mrtdod_y3)==1 & (w3_h_mrtdod_m3==.)) | ((2012-w3_h_mrtdod_y4)==1 & (w3_h_mrtdod_m4==.))] 
...
gen diabmed=.
replace diabmed=1 if w3_a_hldia_med==1 /*Yes*/
replace diabmed=0 if w3_a_hldia_med==2
...
gen tbmed=.
replace tbmed=1 if w3_a_hltb_med==1 /*Yes*/
replace tbmed=0 if w3_a_hltb_med==2 /*No*/
replace tbmed=0 if diag_tb==0 /*No*/
label values tbmed vyesno
label variable tbmed "Current use of TB medication -self"
tab w3_a_hlstrk_med
gen strokemed=.
replace strokemed=1 if w3_a_hlstrk_med==1 /*Yes*/
replace strokemed=0 if w3_a_hlstrk_med==2 /*No*/
...
tab w3_a_hlast_med
gen asthmed=.
replace asthmed=1 if w3_a_hlast_med==1 /*Yes*/
replace asthmed=0 if w3_a_hlast_med==2 /*No*/
...
*Administrative
rename w3_hhid hhid
rename w3_a_intrv_d intd
label var intd "Day of interview"
rename w3_a_intrv_m intm
label var intm "Month of interview"
rename w3_a_intrv_y inty
...
local n = 1
	...
	label var `asset' "NIDS2012 - Asset index indicator - `n'"
	local n = `n' + 1
}
...
collapse (max) primaryed_hh=primaryed (count) edunum=primaryed, by(w3_hhid)
...
merge 1:1 w3_hhid using "$TEMP/TEMP_6B.dta"
keep if _merge==3
drop _merge

replace primaryed_hh=. if primaryed_hh==0 & edunum < w3_hhsizer
...
* Label the dataset
label data "NIDS 2012 - Core Variables - $S_DATE"

save "$TEMP/NIDS2012.dta", replace
